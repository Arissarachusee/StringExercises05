...
console.log(language.slice(0,1)+(4,5));

//c) Use bracket notation and a template literal to print "The abbreviation for 'JavaScript' is 'JS'."
let firstLet = language[0];
let secLet   = language[4];
let combine  = firstLet+secLet ;
console.log(combine);

console.log(`The abbreviation for '${language}' is '${combine}'.`)


//d) Just for fun, try chaining 3 or more methods together, and then print the result.
console.log(`The abbreviation for '${language}' is' '${firstLet+secLet}' `)
